...
export const MAIN_CATEGORIES: MainCategory[] = [
  {
    id: 10, name: 'Skjul', color: '#6b7280', icon: '🚫',
    subCategories: [
  ...
  {
    id: 11, name: 'Inntekt', color: '#16a34a', icon: '💰',
    subCategories: [
  ...
  {
    id: 12, name: 'Bolig', color: '#2563eb', icon: '🏠',
    subCategories: [
  ...
  {
    id: 13, name: 'Bil & Transport', color: '#ea580c', icon: '🚗',
    subCategories: [
      { id: 117, name: 'Billån m.m.', type: 'expense', mainCategoryId: 13, icon: '🚗' },
      { id: 118, name: 'Drivstoff', type: 'expense', mainCategoryId: 13, icon: '⛽' },
      { id: 119, name: 'Bilforsikring & Assistanse', type: 'expense', mainCategoryId: 13, icon: '⚙️' },
      { id: 120, name: 'Årsavgift & Engangsavgift', type: 'expense', mainCategoryId: 13, icon: '📄' },
  ...
  {
    id: 14, name: 'Dagligvarer & Mat', color: '#d97706', icon: '🛒',
    subCategories: [
  ...
  {
    id: 15, name: 'Reise', color: '#0891b2', icon: '✈️',
    subCategories: [
  ...
  {
    id: 16, name: 'Faste utgifter', color: '#7c3aed', icon: '📅',
    subCategories: [
      { id: 134, name: 'Apotek', type: 'expense', mainCategoryId: 16, icon: '💊' },
      { id: 135, name: 'Fagforening & Dagpengeforsikring', type: 'expense', mainCategoryId: 16, icon: '📝' },
  ...
  {
    id: 17, name: 'Fritid', color: '#e11d48', icon: '🎉',
    subCategories: [
      ...
      { id: 150, name: 'Frisør & Personlig pleie', type: 'expense', mainCategoryId: 17, icon: '✂️' },
      { id: 151, name: 'Film, Musikk & Bøker', type: 'expense', mainCategoryId: 17, icon: '🎵' },
      { id: 152, name: 'Kino, Konserter & Underholdning', type: 'expense', mainCategoryId: 17, icon: '🎬' },
      ...
      { id: 157, name: 'Nettjenester & Programvare', type: 'expense', mainCategoryId: 17, icon: '🌐' },
  ...
  {
    id: 18, name: 'Annet', color: '#475569', icon: '📂',
    subCategories: [
  ...
  {
    id: 19, name: 'Gjeld & Renter', color: '#dc2626', icon: '💳',
    subCategories: [
  ...
  {
    id: 20, name: 'Pensjon & Sparing', color: '#059669', icon: '🏦',
    subCategories: [
