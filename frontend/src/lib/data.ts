...
export const batchSetExcludeFromCalculations = wrap(store.batchSetExcludeFromCalculations);
export const setCustomDate = wrap(store.setCustomDate);
export const batchSetCustomDate = wrap(store.batchSetCustomDate);
export const setComment = wrap(store.setComment);
export const batchSetComment = wrap(store.batchSetComment);
export const deleteTransaction = wrap(store.deleteTransaction);
export const batchDeleteTransactions = wrap(store.batchDeleteTransactions);
